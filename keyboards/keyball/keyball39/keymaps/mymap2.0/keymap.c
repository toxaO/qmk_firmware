...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 //,--------------+--------------+--------------+--------------+--------------+--------------.    ,--------------+--------------+--------------+--------------+--------------+--------------.
     KC_MINUS     , XXX          , XXX          , KC_ESC       , EISU_S       , _Sym_SPC     ,      _Cur_ENT     , KANA_C       , XXXXXXX      , XXXXXXX      , XXXXXXX      , _Mou_NumP
 //,-----------------------------------------------------------------------------------------.    ,-----------------------------------------------------------------------------------------.
  ),
 ...
 //,--------------+--------------+--------------+--------------+--------------+--------------.    ,--------------+--------------+--------------+--------------+--------------+--------------.
     XXX          , XXX          , XXX          , XXX          , XXX          , SPD_UP      ,       _______      , XXX          , XXXXXXX      , XXXXXXX      , XXXXXXX      , SLEEP
 //,-----------------------------------------------------------------------------------------.    ,-----------------------------------------------------------------------------------------.
  ),
 ...
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
     KC_A         ,  KC_LEFT     , KC_DOWN      , KC_RIGHT     , M_F2         ,                                    KC_P0        , KC_P4        , KC_P5        , KC_P6        , SFT_T(KC_PAST),
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
     KC_Z         ,  KC_X        , KC_C         , XXX          , XXX          ,                                    KC_PDOT      , KC_P1        , KC_P2        , KC_P3        , KC_PSLS      ,
 //,--------------+--------------+--------------+--------------+--------------+--------------.    ,--------------+--------------+--------------+--------------+--------------+--------------.
     XXX          ,  XXX         , XXX          , KC_ESC       , SFT_T(KC_ENT), KC_SPACE     ,      KC_ENT       , KC_TAB       , XXXXX        , XXXXX        , XXXXX        , _Mou_NumP
 //,-----------------------------------------------------------------------------------------.    ,-----------------------------------------------------------------------------------------.
  ),
 ...
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
     G(KC_A)      , G(KC_S)      , XXX          , G(KC_F)      , XXX          ,                                    APP_SWIPE    , L_CLICK      , R_CLICK      , MO(_Scr)     , XXX          ,
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
     G(KC_Z)      , G(KC_X)      , G(KC_C)      , G(KC_V)      , XXX          ,                                    VOL_SWIPE    , BROWSE_SWIPE , TAB_SWIPE    , MAG_SWIPE    , XXX          ,
 //,--------------+--------------+--------------+--------------+--------------+--------------.    ,--------------+--------------+--------------+--------------+--------------+--------------.
     QUIT         , XXX          , XXX          , XXX          , KC_LSFT      , XXX          ,      XXX          , XXX          , XXXXX        , XXXXXXX      , XXXXXXX      , _______
 //,-----------------------------------------------------------------------------------------.    ,-----------------------------------------------------------------------------------------.
  ),

  [_Scr] = LAYOUT_universal(
 //,--------------------------------------------------------------------------.                                  ,--------------------------------------------------------------------------.
     XXX          , XXX          , XXX          , XXX          , XXX          ,                                    XXX          , KC_BTN4      , KC_BTN5      , XXX          , XXX          ,
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
     XXX          , XXX          , XXX          , XXX          , XXX          ,                                    XXX          , KC_LSFT      , KC_LGUI      , _______      , XXX          ,
 //,--------------+--------------+--------------+--------------+--------------.                                  ,--------------+--------------+--------------+--------------+--------------.
...
void oled_render_layer_state(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        ...
        case _Sym:
            ...
            break;
        case _Cur:
            oled_write_ln_P(PSTR("Cur / Num "), false);
            break;
        case _Mou:
